...
{ askRemoteRep, askPrivateorPublic, askForTemplate } = require('./questions')
...
module.exports = {
  ...
  createRemoteRep: async (userObject, repoName, remoteWebHosting) => {
    // set github creds
    try {
      ...
      var template = await askForTemplate()
    } catch (error) {
